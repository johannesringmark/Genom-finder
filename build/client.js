	...
	setFile: function(evt) {
		...
		for(var i = 0; i < files.length; i++) {
			...
			reader.onload = function(evt) {
				...
				if(item.name.split('.').reverse()[0] === "db23"){
				app.markers_fileparser(app)
				}else{
				app.genom_fileparser(app)
				};
...
},{"indexeddbstore":3}],2:[function(require,module,exports){
...
},{"q":4}],4:[function(require,module,exports){
